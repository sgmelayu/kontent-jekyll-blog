...
module JekyllKenticoSamples
  def create_sample
    #project_id = ENV['PROJECT_ID']
    #cm_api_key = ENV['CM_API_KEY']

    project_id = 'c9ff2cb6-e157-0090-4622-3d19b937d58c'
    secure_key = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..09I7V9N_rLRDAvJOZqaali-MZ0eakOIWvMRkCGOzP-Y'
